    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted text-sm">
          Test member IDs — <span className="font-mono-data text-signal-pass">MEM-1001</span> active,{" "}
      ...
      <form onSubmit={handleSubmit} className="space-y-4 border border-panelLine rounded-xl p-6 bg-panel/60">
        ...
        <Field
          ...
          value={form.prior_treatments_tried}
            ...
            <>
              <div className="flex items-center gap-4">
                ...
                <span className="font-mono-data text-sm text-muted">
                  score {result.weighted_confidence_score}
                </span>
              </div>
              ...
              {result.record_id && (
                <p className="text-sm text-muted">
                  Saved as record #{result.record_id} — review it in the Queue tab.
                </p>
              )}
            </>
          )}
